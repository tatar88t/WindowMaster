...
var clearInputs = function clearInputs(inputSelect, optionSelect, checkBoxSelect) {
  ...
  checkBoxSelect.forEach(function (box) {
    box.checked = false;
  });
};
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        Object(_clearInputs__WEBPACK_IMPORTED_MODULE_7__["default"])(inputs, windowType, windowProfile);
      });
    });
  });
};
...
/* harmony import */ var _clearInputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./clearInputs */ "./src/js/modules/clearInputs.js");
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var pass = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (Object.keys(state).length == pass) {
          windows.forEach(function (item) {
            item.style.display = 'none';
          });
    ...
    close.addEventListener('click', function () {
      ...
      Object(_clearInputs__WEBPACK_IMPORTED_MODULE_3__["default"])(inputs, windowType, windowProfile);
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, 5);
  showModalByTime('[data-modal]', 10000);
};
